...
const CardEdit = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formData.append('countInStock', Number(product.countInStock));
    ...
    <div className='center'>
      <div className='edit-container'>
        ...
        <form className='edit-form' onSubmit={handleSubmit} encType='multipart/form-data'>
          ...
          <label>Stoc actual (Bucăți)</label>
          <input name='countInStock' type='number' min='0' value={product.countInStock || 0} onChange={handleChange} required />
